...
<div class="wrapper">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo e(url('/professor')); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Professor Mgt</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(url('/subject')); ?>" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Subject Mgt</p>
                </a>
            </ul>
  ...
  <div class="content-wrapper">
    ...
    <?php if($layout == 'subjectIndex'): ?>
    <div class="container-fluid mt-4">
        <div class="container-fluid mt-4">
            <div class="row justify-content-center">
                <section class="col-md-12">
                    <?php echo $__env->make("subjectslist", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </section>
            </div>
        </div>
    </div>
<?php elseif($layout == 'subjectCreate'): ?>
            ...
            <section class="col-md-5">
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <br>
                        <form action="<?php echo e(url('/subjectStore')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <br>
                            <br>
                            ...
                            <div class="form-group">
                                ...
                                <select name="Prof_ID">
                                  ...
                                  <!-- <option value=""><?php echo e($professor->Prof_fname.' '.$professor->Prof_mname.' '.$professor->Prof_lname); ?></option> -->
                                  <option value=""><?php echo e($professor->id); ?></option>
...
<?php elseif($layout == 'subjectShow'): ?>
    <div class="container-fluid mt-4">
      <h6 class='$classname'><?php echo e($message); ?></h6>
        <div class="row">
            <section class="col">
                <?php echo $__env->make("subjectslist", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </section>
            ...
            <section class="col-md-5">
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(url('/subjectUpdate/'.$subject->id)); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <br>
                            <div class="form-group">
                                <label>Subject Title</label>
                                <input value="<?php echo e($subject->Subj_title); ?>" name="Subj_title" type="text" class="form-control"  placeholder="Enter First Name">
                            </div>
                            <div class="form-group">
                                <label>Subject Day</label>
                                <input value="<?php echo e($subject->Subj_day); ?>" name="Subj_day" type="text" class="form-control"  placeholder="Enter Last Name">
                            </div>

                            
                            <div class="form-group">
                                <label>Subject Time</label>
                                <input value="<?php echo e($subject->Subj_time); ?>"name="Subj_time" type="text" class="form-control"  placeholder="Enter Middle Name">
                            </div>
                            
                            <div class="form-group">
                                <label>Subject Description</label>
                                <input value="<?php echo e($subject->Subj_desc); ?>" name="Subj_desc" type="text" class="form-control"  placeholder="Enter Subject ID">
                            </div>

                            <div class="form-group">
                                <label>Subject Units</label>
                                <input value="<?php echo e($subject->Subj_units); ?>" name="Subj_units" type="text" class="form-control"  placeholder="Enter Subject ID">
                            </div>

                            <div class="form-group">
                                <label>Subject Room</label>
                                <input value="<?php echo e($subject->Subj_room); ?>" name="Subj_room" type="text" class="form-control"  placeholder="Enter Subject ID">
                            </div>

                            <div class="form-group">
                                <label>Subject Yr & Sec</label>
                                <input value="<?php echo e($subject->Subj_yr_sec); ?>" name="Subj_yr_sec" type="text" class="form-control"  placeholder="Enter Subject ID">
                            </div>

                            <div class="form-group">
                                <label>Professor ID</label>
                                <input value="<?php echo e($subject->Prof_ID); ?>" name="Prof_ID" type="number" class="form-control"  placeholder="Enter Subject ID">
                            </div>
...
<?php /**PATH C:\xampp\htdocs\pm\trial_error1\resources\views/subject.blade.php ENDPATH**/ ?>