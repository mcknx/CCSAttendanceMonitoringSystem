        ...
        <table class="table table-responsive">
            ...
            <?php $__currentLoopData = $professors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $professor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo e(url('/professorShow/'.$professor->id)); ?>" class="btn btn-sm btn-warning">Show</a>
                    </td>
                </tr>
...
<?php /**PATH C:\xampp\htdocs\pm\trial_error1\resources\views/professorslist.blade.php ENDPATH**/ ?>